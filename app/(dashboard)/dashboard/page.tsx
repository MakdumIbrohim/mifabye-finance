  ...
  return (
        ...
        <div className="relative">
          ...
          <div className="flex justify-between items-start mb-8">
            ...
            <div className="flex items-center gap-3">
              {/* Wallet Watermark/Logo */}
              <div className="p-2 rounded-xl bg-white/5 border border-white/10 hidden sm:block">
          ...
          <div className="mb-10 space-y-1">
            <p className="text-[10px] font-black uppercase tracking-[0.3em] text-white/50 ml-1">Total Saldo</p>
    ...
    <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
            ...
            <form onSubmit={handlePreSubmit} className="space-y-6">
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <textarea
                    placeholder={transactionType === "in" ? "Contoh: Order makalah 10 halaman" : "Contoh: Pengeluaran untuk pembelian canva pro"}
                    className="w-full bg-subtle border border-border rounded-xl p-2.5 text-sm font-bold h-24 text-foreground focus:ring-2 focus:ring-primary/20 outline-none transition-all resize-y"
        ...
        <div className="lg:col-span-8 space-y-8">
          {/* Chart Section */}
          <div className="subtle-card p-6 xl:p-8 min-h-[400px]">
