            ...
            <form onSubmit={handleUpdate} className="p-6">
              ...
              <div className="mt-8 flex gap-3">
                ...
                <button 
                  ...
                  className="flex-1 py-3 bg-primary text-white font-bold text-[11px] uppercase tracking-wider rounded-xl shadow-lg shadow-primary/20 hover:opacity-90 active:scale-95 transition-all flex items-center justify-center gap-2"
                >
                   {isProcessing ? (
                     <>
