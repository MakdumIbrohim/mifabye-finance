                  ...
                  <div className={`p-5 ${svc.color} text-white rounded-t-[1.5rem]`}>
                   ...
                   <div className={`p-6 space-y-4 ${isDarkMode ? "bg-slate-900" : "bg-white"} rounded-b-[1.5rem]`}>
                    ...
                    {svc.category === "6. IT Solutions" && (
                      <p className={`mt-4 text-[9px] italic flex items-start gap-1.5 leading-tight ${isDarkMode ? "text-slate-500" : "text-text-muted"}`}>
                        <svg className="w-3 h-3 flex-shrink-0 mt-0.5 text-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>
