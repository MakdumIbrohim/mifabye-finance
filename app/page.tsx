...
const services = [
  {
    ...
    color: "bg-blue-600",
    items: [
      { name: "Buku Kecil A5", price: "3k/halaman" },
      { name: "Buku Besar", price: "5k/halaman" },
      { name: "Kertas Folio", price: "7k/halaman" },
    ]
  },
  {
    ...
    color: "bg-blue-600",
    items: [
      { name: "Makalah", price: "5k/halaman" },
      { name: "Esai", price: "5k/halaman" },
      { name: "Artikel", price: "start 30k" },
      { name: "Artikel Jurnal", price: "start 50k" },
      { name: "Proposal", price: "5k/halaman" },
      { name: "Laporan", price: "5k/halaman" },
      { name: "Resume/Review", price: "5k/halaman" },
      { name: "PPT (Tanpa Animasi)", price: "2k/slide" },
      { name: "Pembuatan Kuesioner", price: "10k" },
      { name: "Membuat Cerpen (Cust)", price: "15k" },
      { name: "Membuat Cerpen (Mifa)", price: "25k" },
      { name: "Buat Modul (Word)", price: "5k/hal" },
      { name: "Buat Modul (Canva)", price: "10k/hal" },
  ...
  },
  {
    ...
    color: "bg-blue-600",
    items: [
      { name: "Microsoft Word", price: "3k/halaman" },
      { name: "Excel", price: "3k/halaman" },
      { name: "Bahasa Inggris", price: "3k/halaman" },
      { name: "Rumus Matematika (Word)", price: "3k/halaman" },
    ]
  },
  {
    ...
    color: "bg-blue-600",
    items: [
      { name: "Daftar Isi/Gambar/Tabel", price: "5k/halaman" },
      { name: "Merapikan Isi File", price: "1k/halaman" },
      { name: "Penomoran Halaman", price: "1k/2 hal" },
      { name: "Koreksi Typo", price: "1k/2 hal" },
      { name: "Add Dapus (Mendeley)", price: "2k/sumber" },
      { name: "Add Dapus (Manual)", price: "3k/sumber" },
      { name: "Cari Sumber & Dapus", price: "5k/sumber" },
    ]
  },
  {
    ...
    color: "bg-blue-600",
    items: [
      { name: "CV Professional", price: "10k" },
      { name: "Surat Lamaran Kerja", price: "10k-20k" },
      { name: "Buat Poster", price: "10k-40k" },
      { name: "Undangan Pernikahan Web", price: "50k-150k" },
      { name: "Sertifikat Digital", price: "10k/sertif" },
      { name: "Feed IG Menarik", price: "10k/feed" },
      { name: "Mind Map / Flowchart", price: "5k-10k" },
      { name: "Edit Foto Sederhana", price: "5k/foto" },
    ]
  }
];
