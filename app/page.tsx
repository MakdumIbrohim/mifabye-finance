      ...
      <main className="relative pt-32 pb-20 px-6">
        ...
        <section className="max-w-4xl mx-auto mb-32 animate-fade-in">
          ...
          <div className="text-center space-y-12">
            ...
            <div className="flex flex-wrap items-center justify-center gap-4 pt-4">
              ...
              <a href="https://wa.me/6285854894312?text=Halo%20Mifabyte%2C%20saya%20ingin%20konsultasi%20terkait%20tugas%20akademik%20saya.%20Boleh%20bantu%3F" target="_blank" className={`px-8 h-[60px] border rounded-2xl font-bold text-base transition-all flex items-center gap-3 shadow-lg ${isDarkMode ? "bg-slate-900 border-slate-800 text-white hover:bg-slate-800 shadow-black/20" : "bg-white border-border text-slate-900 hover:bg-bg-subtle shadow-black/5"}`}>
        ...
        <footer className={`max-w-4xl mx-auto text-center border-t pt-12 transition-colors duration-300 ${isDarkMode ? "border-slate-800" : "border-border"}`}>
          <div className="flex items-center justify-center gap-6 mb-8">
            ...
            <a href="https://wa.me/6285854894312?text=Halo%20Mifabyte%2C%20saya%20ingin%20konsultasi%20terkait%20tugas%20akademik%20saya.%20Boleh%20bantu%3F" target="_blank" className={`flex items-center gap-2 text-sm font-bold transition-colors ${isDarkMode ? "text-slate-500 hover:text-green-500" : "text-text-muted hover:text-green-500"}`}>
